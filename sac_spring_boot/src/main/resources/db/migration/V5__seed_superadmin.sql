...
INSERT IGNORE INTO `super_admins` (`id`, `username`, `email`, `password`, `full_name`, `phone_number`, `active_status`, `role`) VALUES 
...
INSERT IGNORE INTO `users` (`id`, `name`, `email`, `username`, `password`, `phone`, `is_administrator`, `active_status`, `role_id`, `school_id`) VALUES 
